...
;(() => {
  ...
  function filledInCard() {
    document.getElementsByClassName("projectCard")[0].innerHTML = `
        ${createNewproCard(
          "https://bigonion.cn/MarkdownOnline",
        ...
        `
    document.getElementsByClassName("projectCard")[1].innerHTML = `
        ${createNewproCard(
        ...
        `
    document.getElementsByClassName("projectCard")[2].innerHTML = `
        ${createNewproCard(
          "https://github.com/LiWeny16/OLANBox",
        ...
        `
    document.getElementsByClassName("projectCard")[3].innerHTML = `
        ${createNewproCard(
          "https://github.com/LiWeny16/caculator_verilogHDL",
    ...
    document.getElementsByClassName("projectCard")[5].innerHTML = `
        ${createNewproCard(
          "https://github.com/LiWeny16/Msp430_UESTC_project_design",
